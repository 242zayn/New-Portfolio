...
const en = {
  ...
  hero: {
    ...
    action: {
      ...
      description:
        "From initial loading to user interaction, we guarantee an exceptional experience. Boost your online success with fast, efficient, and responsive web pages.",
    },
    button_aria: "Slide",
  },
  technologies: {
